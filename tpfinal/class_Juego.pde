class Juego {
  ...
  Juego (PImage imgProtagonista, PImage imgVictoria, PImage imgDerrota1, PImage imgDerrota2, PImage imgParticula) {
    ...
    pincho1 = new Antagonista ("Pinchos", imgPinchos[0], random (100, 500), 300);
    pincho2 = new Antagonista ("Pinchos", imgPinchos[1], random (500, 900), 450);
    pincho3 = new Antagonista ("Pinchos", imgPinchos[2], random (900, 1400), 600);
